...
/**
 * GLIBC_SubmissionOverviewChart short summary.
 *
 * GLIBC_SubmissionOverviewChart description.
 *
 * @version 1.0
 * @author Filip
 */
class GLIBC_SubmissionOverviewChart
{
    /**
    ...
    public static function GetSubmissionOverviewChart(SubmissionTSE $submission)    {
        ...
        $googleChart->setOptions(GLIBC_SubmissionOverviewChart::GetGCOptions());
        
        // Get data
        $googleChart->setData(GLIBC_SubmissionOverviewChart::GetGCData($submission));
