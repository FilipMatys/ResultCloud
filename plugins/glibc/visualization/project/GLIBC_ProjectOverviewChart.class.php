...
/**
 * GLIBC_ProjectOverviewChart short summary.
 *
 * GLIBC_ProjectOverviewChart description.
 *
 * @version 1.0
 * @author Filip
 */
class GLIBC_ProjectOverviewChart
{
    /**
    ...
    public static function GetProjectOverviewChart(ProjectTSE $project)    {
        ...
        $googleChart->setOptions(GLIBC_ProjectOverviewChart::GetGCOptions());
        
        // Get data
        $googleChart->setData(GLIBC_ProjectOverviewChart::GetGCData($project));
