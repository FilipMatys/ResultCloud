...
/**
 * CPAlien_SubmissionOverviewChart short summary.
 *
 * CPAlien_SubmissionOverviewChart description.
 *
 * @version 1.0
 * @author Filip
 */
class CPAlien_SubmissionOverviewChart
{
    /**
    ...
    public static function GetSubmissionOverviewChart(SubmissionTSE $submission)    {
        ...
        $googleChart->setOptions(CPAlien_SubmissionOverviewChart::GetGCOptions());
        
        // Get data
        $googleChart->setData(CPAlien_SubmissionOverviewChart::GetGCData($submission));
