...
/**
 * ProjectVisualization short summary.
 *
 * ProjectVisualization description.
 *
 * @version 1.0
 * @author Filip
 */
class ProjectVisualization
{
    ...
    public static function Visualize(ProjectTSE $project, $type)   {
        ...
        switch ($type)  {
            // Get google chart
            case ProjectOverviewType::GOOGLE_CHART:
                return CPAlien_ProjectOverviewChart::GetProjectOverviewChart($project);
            
            // Get list view
            case ProjectOverviewType::VIEWLIST:
                return CPAlien_ProjectOverviewList::GetProjectOverviewList($project);
