...
/**
 * SystemTAP_DifferenceOverviewChart short summary.
 *
 * SystemTAP_DifferenceOverviewChart description.
 *
 * @version 1.0
 * @author Filip
 */
class SystemTAP_DifferenceOverviewChart
{
    /**
    ...
    public static function GetDifferenceOverviewChart($submissions)    {
        ...
        $googleChart->setOptions(SystemTAP_DifferenceOverviewChart::GetGCOptions());
        
        // Get data
        $googleChart->setData(SystemTAP_DifferenceOverviewChart::GetGCData($submissions));
