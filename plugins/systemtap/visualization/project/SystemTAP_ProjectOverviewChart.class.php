...
/**
 * SystemTAP_ProjectOverviewChart short summary.
 *
 * SystemTAP_ProjectOverviewChart description.
 *
 * @version 1.0
 * @author Filip
 */
class SystemTAP_ProjectOverviewChart
{
    /**
    ...
    public static function GetProjectOverviewChart(ProjectTSE $project)    {
        ...
        $googleChart->setOptions(SystemTAP_ProjectOverviewChart::GetGCOptions());
        
        // Get data
        $googleChart->setData(SystemTAP_ProjectOverviewChart::GetGCData($project));
